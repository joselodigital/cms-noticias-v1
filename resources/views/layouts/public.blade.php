                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                            ...
                            @if(isset($social_links) && $social_links->count() > 0)
                                <div class="flex items-center space-x-3 ml-2 border-l border-gray-200 dark:border-gray-700 pl-4">
                                    @foreach($social_links as $link)
                                        <a href="{{ $link->url }}" target="_blank" class="text-gray-400 hover:text-blue-500 transition-colors duration-200" title="{{ $link->name }}">
                ...
                <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li>
                                    <a href="{{ route('home') }}" class="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Inicio</a>
                                </li>
                                <li>
                                    <a href="{{ route('news.index') }}" class="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Noticias</a>
                                </li>
                                @if(isset($navbarCategories))
                        ...
                        <div>
                            ...
                            <p class="text-base text-gray-500 dark:text-gray-400 mb-4">
                                Somos tu fuente confiable de noticias actualizadas. Cubrimos los eventos más importantes con objetividad y rapidez.
                            </p>
                            ...
                            @if(\App\Models\Page::where('slug', 'condiciones-de-uso')->where('is_active', true)->exists())
                                <a href="{{ route('pages.show', 'condiciones-de-uso') }}" class="text-sm text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">
                                    Condiciones de Uso
                                </a>
                            @endif
                        </div>
